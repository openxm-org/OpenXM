%%  $OpenXM: OpenXM/doc/OpenXM-specs/OpenXM.tex,v 1.12 2000/11/30 02:41:36 takayama Exp $
\documentclass{article}
\IfFileExists{epsfig.sty}{\usepackage{epsfig}}{}
\usepackage{html}
\begin{document}
/*&jp
\title{{\bf Open XM の設計と実装 (OpenXM RFC 100)} \\
...
*/
/*&eg
\title{{\bf Design and Implementation of OpenXM (OpenXM RFC 100)} \\
 --- Open message eXchange protocol for Mathematics 
}
