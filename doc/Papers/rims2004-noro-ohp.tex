...
$F = \Q[\alpha_1,\ldots,\alpha_l] = \Q[T]/I$
...
実行を観察すると $\cdots$ 生成される中間基底の頭項の $t$ 変数がだんだん消滅 
= 頭係数の逆元計算を S-多項式と単項簡約で実行
...
入力に最小多項式を追加して実行 + 正規形の monic 化
入力は {\tt Alg} 型を係数に含む多項式集合でよい. 
...
\end{eqnarray*}}
$Cyc$: cyclic-7 の $c_6$ に 1 の原始 7 乗根を代入
