...
\title{\bf Risa/Asir 上の新グレブナー基底計算パッケージについて}
...
{\tt DL} : 32bit 整数配列 (1 要素 32bit で固定)
...
\begin{slide}{効率化の工夫 --- 配列による多項式の保持}
...
\begin{slide}{効率化の工夫 --- 関数のインライン化, unrolling}
...
\begin{slide}{効率化の工夫 --- reducer サーチのハッシュ化}
...
\begin{slide}{性能 --- 有限体上での cyclic-$n$ }
