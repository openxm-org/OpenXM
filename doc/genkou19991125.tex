...
%% $OpenXM: OpenXM/doc/genkou19991125.tex,v 1.117 1999/12/30 14:21:34 ohara Exp $
...
数学的な計算を行なうための HTTP に似たプロトコル.
%クライアント・サーバモデルを採用している.
MCP の視野は主に control integration であり,
交換に用いられる数学データの表現方法については規定されていない.
したがって数学的なデータの表現には MP や OpenMath で定め
