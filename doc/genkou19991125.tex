...
%% $OpenXM: OpenXM/doc/genkou19991125.tex,v 1.84 1999/12/25 09:05:48 tam Exp $
...
SM\_executeStringByLocalParser を利用可能
%(実際にはこのような命令コードは存在しない)
%{\Large じゃあ書くな}
であれば, $B$ の部分は
\begin{quote}
(CMO\_LIST, {\sl int32} $5$,
	(CMO\_INT32, SM\_popCMO), (CMO\_INT32, SM\_popString),
		(CMO\_INT32, SM\_mathcap),
...
\begin{quote}
  ...
  \ \ (CMO\_LIST, {\sl int32} $2$, (CMO\_INT32, OX\_DATA), \\
  \ \ \ \ (CMO\_LIST, {\sl int32} $4$,
            (CMO\_INT32, CMO\_INT32), (CMO\_INT32, CMO\_STRING),
            (CMO\_INT32, CMO\_MATHCAP), (CMO\_INT32, CMO\_LIST))))
\end{quote}
となる.
