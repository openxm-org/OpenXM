...
%% $OpenXM: OpenXM/doc/genkou19991125.tex,v 1.80 1999/12/25 04:08:50 tam Exp $
...
ジェクトをスタックに積む。
\item
クライアントがサーバに命令を送ると、あらかじめ定めれらた動作を行う。一部
の命令はスタックの状態を変更する。例えば SM\_executeFunction,
SM\_executeStringByLocalParser など命令は、スタック上のオブジェクトから
