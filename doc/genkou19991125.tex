...
%% $OpenXM: OpenXM/doc/genkou19991125.tex,v 1.96 1999/12/26 06:33:32 ohara Exp $
...
バとクライアントの間で行なわれる.\footnote{これの拡張は, いま主に野呂
が考えてる.  サーバ同士通信できないと効率的並列計算の実験には使えない.}
クライアントからサーバへメッセージを送
...
数学的なオブジェクトを MP や MathML で定められた方法で表現することが考え
られている.  すでに OpenMath を用いた実装が存在する.
