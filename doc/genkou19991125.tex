...
%% $OpenXM: OpenXM/doc/genkou19991125.tex,v 1.81 1999/12/25 04:43:38 ohara Exp $
...
\begin{quote}
  ...
  \ \ (CMO\_LIST, {\sl int32} $2$, {\sl cmo\_int32} 514,
...
ドをクライアントが作成し, そのパスワードを使って認証を行なう. このパスワードは一旦使用
