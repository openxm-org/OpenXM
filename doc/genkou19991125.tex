...
%% $OpenXM: OpenXM/doc/genkou19991125.tex,v 1.113 1999/12/28 14:03:30 tam Exp $
...
数学的なデータの表現とバイトストリームへのエンコーディングを
提供するプロジェクト.
このプロジェクトでは, 数学ソフト間で数学データをやりとりする際の
通信路上での表現方法を規定している.
数学データは木構造を使って表しており, OpenMath と同様,
異なる種類の数式処理システム間で意味の食い違いが起こらないよう,
情報を付加できるようになっている.
また, 通信路はピアツーピアのバイトストリームでなければならないが,
通信方法には幾らかの自由度があり,
