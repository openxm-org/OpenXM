...
%% $OpenXM: OpenXM/doc/genkou19991125.tex,v 1.95 1999/12/26 04:11:54 tam Exp $
...
もある.}  そこで, この論文では具体的な実装は TCP/IP を用いていると仮定す
る.
...
えられるが, 例えば MCP を用いた実装があり, GAP と Axiom の間で通信が行わ
