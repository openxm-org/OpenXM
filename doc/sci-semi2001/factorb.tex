% $OpenXM: OpenXM/doc/sci-semi2001/factorb.tex,v 1.1 2001/07/23 06:46:51 noro Exp $
...
\underline{\uc コンピュータには力技(繰り返し)が似合う}
...
$M$ を整数とする. {\eec $a \equiv b \bmod M$} とは

\begin{itemize}
\item $a,b$ が整数のとき, 

{\eec $a-b$ が $M$ で割り切れる}こと

\item $a,b$ が整数係数多項式のとき

{\eec $a-b$ の各係数が $M$ で割り切れる}こと
\end{itemize}

\vskip 1cm

\underline{\uc $a$ を $M$ で割った余りも $a \bmod M$ と書く}
\end{slide}
...
一方が $b_0$, 他方が $c_0$ $\Rightarrow$ これらは同じもの
\end{slide}

\begin{slide}{}
\underline{\uc 二次因子つづき --- $b_1$, $c_1$ が満たす性質}
