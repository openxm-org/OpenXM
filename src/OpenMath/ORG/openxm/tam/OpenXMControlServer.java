 ...
 */
public abstract class OpenXMControlServer{
  private OpenXMControlServer server = null;
  ...
  public OpenXMControlServer(){
    this("localhost",1200,1300);
  }

  public OpenXMControlServer(String host,int CtrlPort,int StreamPort){
    server = this;
