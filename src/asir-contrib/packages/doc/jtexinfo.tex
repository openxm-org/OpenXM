...
\def\exdentyyy #1{{\hfil\break\hbox{\kern -\exdentamount{\rm\mc #1}}\hfil\break}}

% This defn is used inside nofill environments such as @example.
\def\nofillexdent{\parsearg\nofillexdentyyy}
\def\nofillexdentyyy #1{{\advance \leftskip by -\exdentamount
\leftline{\hskip\leftskip{\rm\mc #1}}}}
...
% enhancements of @node by kusumi@isl.mei
%   to treat following node correctly.(containing '[' and ']' in this order)
%     @node $[, $], $prev, $upper
...
\font\secbf=cmbx10 scaled \magstep2
%**
\ifisJTeX
\ifisASCII
...
\font\sseci=cmmi10 scaled \magstep1
...
\font\titlerm = cmbx10 scaled \magstep4
\ifisJTeX
\ifisASCII
...
\font\shortcontbf=cmbx10 scaled \magstephalf
\font\shortcontsl=cmsl10 scaled \magstephalf
%**
\ifisJTeX
\ifisASCII
...
\newdimen\tclosesave
\newdimen\tcloserm
\def\tclose#1{{\rm\mc \tcloserm=\fontdimen2\font \tt \tclosesave=\fontdimen2\font
...
\def\titlefont#1{{\titlerm\titlemc #1}}
...
\def\doprintindex#1{%
  ...
  \catcode`\~=\other
  \catcode`\@ =11% kusumi@isl.mei.co.jp
  %
  ...
  \indexfonts\rm\mc \tolerance=9500 \advance\baselineskip -1pt
  \begindoublecolumns
  %
...
\line{\secbf\secgt#1\hfill}\kern 2pt\penalty10000}}
...
\global\advance \chapno by 1 \message{\strchapapp\the\chapno\strchaptail}%
\chapmacro {#1}{\the\chapno}%
\gdef\thissection{#1}%
\gdef\thischaptername{#1}%
% We don't substitute the actual chapter name into \thischapter
% because we don't want its macros evaluated now.
\xdef\thischapter{\strchapapp\the\chapno\strchaptail: \noexpand\thischaptername}%
{\chapternofonts%
...
\secno=0 \subsecno=0 \subsubsecno=0
\global\advance \appendixno by 1 \message{\strappendix\appendixletter}%
\chapmacro {#1}{\strappendix\appendixletter}%
\gdef\thissection{#1}%
\gdef\thischaptername{#1}%
\xdef\thischapter{\strappendix\appendixletter: \noexpand\thischaptername}%
{\chapternofonts%
...
{\chapfonts \vbox{\hyphenpenalty=10000\tolerance=5000
                  \parindent=0pt\raggedright
                  \rm\mc #1\hfill}}\bigskip \par\penalty 10000 %
}
...
\rlap{\rightline{{\rm\mc #2}\hskip \deftypemargin}}}%
...
% omitted.
% 
\def\pxref#1{\strseeapp\xrefX[#1,,,,,,,]\strseetail}
\def\xref#1{\strSeeapp\xrefX[#1,,,,,,,]\strseetail}
\def\ref#1{\xrefX[#1,,,,,,,]}
...
\else%
\turnoffactive%
\refx{#1-snt}{} [\printednodename], \strpageapp\tie\refx{#1-pg}{}\strpagetail%
\fi
\endgroup}
...
\ifnum\secno=0 \strchapapp\xreftie\the\chapno\strchaptail %
\else \ifnum \subsecno=0 \strsecapp\xreftie\the\chapno.\the\secno\strsectail %
\else \ifnum \subsubsecno=0 %
\strsecapp\xreftie\the\chapno.\the\secno.\the\subsecno\strsectail %
\else %
\strsecapp\xreftie\the\chapno.\the\secno.\the\subsecno.\the\subsubsecno\strsectail %
\fi \fi \fi }

\def\Yappendixletterandtype{%
\ifnum\secno=0 \strappendix\xreftie'char\the\appendixno{}%
\else \ifnum \subsecno=0 \strsecapp\xreftie'char\the\appendixno.\the\secno\strsectail %
\else \ifnum \subsubsecno=0 %
\strsecapp\xreftie'char\the\appendixno.\the\secno.\the\subsecno\strsectail %
\else %
\strsecapp\xreftie'char\the\appendixno.\the\secno.\the\subsecno.\the\subsubsecno\strsectail %
\fi \fi \fi }
