#!/bin/bash
# $OpenXM: OpenXM/src/asir-port/cgi/cgi-asir-r-fd2.sh,v 1.2 2014/09/01 02:41:48 takayama Exp $
...
export TMP=/tmp
export CGI_ASIR_ALLOW="[(version) (asir_contrib_copyright) (r_ahvec) (a_expect) (r_expect) ]"
