% $OpenXM: OpenXM/src/kan96xx/Doc/changelog-ja.tex,v 1.2 2004/08/22 02:00:24 takayama Exp $
...
\section{2004-08-22, lcm, polylcm, gcd, polygcd}
\begin{enumerate}
\item polylcm, polygcd は ox を用いる.
\item mpzext (lcm, gcd).  int32 は universalNumber (mpz_int) へ自動変換.
...
\begin{enumerate}
\item {\tt to\_int}, {\tt Kto\_int} で univNum を int32 へ.
