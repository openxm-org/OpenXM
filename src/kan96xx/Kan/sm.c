/* sm.c   $OpenXM: OpenXM/src/kan96xx/Kan/sm.c,v 1.9 2000/02/24 00:27:12 takayama Exp $ */
#define DATE "2000/02/24"
#define RELEASE "3.000224"    /* This "string" must be an increasing seq.*/
