/* sm.c   $OpenXM: OpenXM/src/kan96xx/Kan/sm.c,v 1.11 2000/03/20 01:53:46 takayama Exp $ */
#define DATE "2000/06/07"
#define RELEASE "3.000607"    /* This "string" must be an increasing seq.*/
