/* sm.c   $OpenXM: OpenXM/src/kan96xx/Kan/sm.c,v 1.10 2000/02/24 12:33:47 takayama Exp $ */
#define DATE "2000/03/20"
#define RELEASE "3.000320"    /* This "string" must be an increasing seq.*/
