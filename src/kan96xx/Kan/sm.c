/* sm.c   $OpenXM: OpenXM/src/kan96xx/Kan/sm.c,v 1.3 1999/11/06 10:37:30 takayama Exp $ */
#define DATE "1999/11/18"
#define RELEASE "2.991118"    /* This "string" must be an increasing seq.*/
