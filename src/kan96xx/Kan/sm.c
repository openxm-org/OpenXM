/* sm.c   $OpenXM: OpenXM/src/kan96xx/Kan/sm.c,v 1.4 1999/11/18 00:54:16 takayama Exp $ */
#define DATE "1999/11/25"
#define RELEASE "2.991125"    /* This "string" must be an increasing seq.*/
