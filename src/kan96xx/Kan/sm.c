/* sm.c   $OpenXM: OpenXM/src/kan96xx/Kan/sm.c,v 1.12 2000/06/08 08:35:03 takayama Exp $ */
#define DATE "2000/07/26"
#define RELEASE "3.000726"    /* This "string" must be an increasing seq.*/
