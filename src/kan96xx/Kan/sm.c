/* sm.c   $OpenXM: OpenXM/src/kan96xx/Kan/sm.c,v 1.2 1999/10/30 02:20:54 takayama Exp $ */
#define DATE "1999/11/06"
#define RELEASE "2.991106"    /* This "string" must be an increasing seq.*/
