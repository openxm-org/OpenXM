/* sm.c   $OpenXM: OpenXM/src/kan96xx/Kan/sm.c,v 1.16 2001/08/21 14:12:46 takayama Exp $ */
#define DATE "2002/09/08"
#define RELEASE "3.020908"    /* This "string" must be an increasing seq.*/
