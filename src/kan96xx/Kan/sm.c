/* sm.c   $OpenXM: OpenXM/src/kan96xx/Kan/sm.c,v 1.8 2000/02/02 09:07:59 takayama Exp $ */
#define DATE "2000/02/22"
#define RELEASE "3.000222"    /* This "string" must be an increasing seq.*/
