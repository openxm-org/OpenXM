/* $OpenXM: OpenXM/src/ox_ntl/crypt/des/des3.h,v 1.1 2005/06/19 15:30:01 iwane Exp $ */
/*
 * Triple-DES
 */
...
int	des3_enc_cbc(const des3_key *, unsigned char *, int len, const unsigned char *, unsigned char *);
